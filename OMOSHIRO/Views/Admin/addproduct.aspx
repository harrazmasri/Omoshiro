<%@ Page Title="" Language="C#" MasterPageFile="../DashboardAdmin.Master" AutoEventWireup="true" CodeBehind="addproduct.aspx.cs" Inherits="OMOSHIRO.Views.Admin.addproduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnAdd" runat="server" Text="Add Product" CssClass="hover:cursor-pointer  bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded" OnClick="btnAdd_Click" />
</div>
