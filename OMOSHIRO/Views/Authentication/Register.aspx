...
<asp:Content ID="Content1" ContentPlaceHolderID="AuthPlaceholder" runat="server">
    ...
    <div class="mb-1 rounded bg-slate-800 py-2 px-4">
        ...
        <asp:TextBox ID="Email" runat="server" CssClass="w-full rounded text-[1rem] outline-none border-none bg-slate-800 ring-0"></asp:TextBox>
    </div>
    <div class="mb-1 rounded bg-slate-800 py-2 px-4">
    ...
    <div class="mb-1 rounded bg-slate-800 py-2 px-4">
        ...
        <asp:TextBox ID="RepPassword" runat="server" CssClass="w-full rounded text-[1rem] outline-none border-none bg-slate-800 ring-0"></asp:TextBox>
    </div>
    <asp:Button ID="RegisterButton" runat="server" Text="Register" CssClass="w-full mt-4 hover:cursor-pointer label rounded outline-none border-none ring-0 bg-slate-700 hover:bg-purple-700 transition py-2 px-4" />
